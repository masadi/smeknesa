...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$http.get('/auth/semester').then(function (response) {
      ...
      _this.semester_id = getData.aktif.semester_id;
        ...
        if (success) {
          _this2.$http.post('/auth/login', {
            ...
            if (userData) {
              ...
              _this2.$ability.update(userData.ability);

              // ? This is just for demo purpose as well.
              // ? Because we are showing eCommerce app's cart items count in navbar

              // ? This is just for demo purpose. Don't think CASL is role based in this case, we used role in if condition just for ease
              _this2.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_11__["getHomeRouteForLoggedInUser"])(userData.roles)).then(function () {
                _this2.$toast({
                  component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
                  position: 'top-right',
                  props: {
                    title: "Welcome ".concat(userData.name),
                    icon: 'CoffeeIcon',
                    variant: 'success',
              ...
              _this2.$refs.loginForm.setErrors(response.data.errors);
            }
