...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rencana_ukk', function (Blueprint $table) {
			...
			$table->foreign('internal')->references('guru_id')->on('guru')->onUpdate('CASCADE')->onDelete('CASCADE');
			$table->foreign('eksternal')->references('guru_id')->on('guru')->onUpdate('CASCADE')->onDelete('CASCADE');
