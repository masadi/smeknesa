        ...
        this.data_siswa.forEach(function(value, key) {
          ...
          if(value.anggota_rombel.single_deskripsi_mata_pelajaran){
            ...
            if(value.anggota_rombel.tp_kompeten.length){
              ...
              kompeten[value.anggota_rombel.anggota_rombel_id] = 'Menunjukkan penguasaan yang baik dalam '+tempTpKompeten.join(' dan ')
            } else {
            ...
            if(value.anggota_rombel.tp_inkompeten.length){
              ...
              inkompeten[value.anggota_rombel.anggota_rombel_id] = 'Perlu ditingkatkan dalam '+tempTpInKompeten.join(' dan ')
            } else {
