<template>
  <b-card no-body>
    <b-card-body>
      ...
      <div v-else>
        <datatable :isAsesor="isAsesor" :isBusy="isBusy" :items="items" :fields="fields" :meta="meta" @per_page="handlePerPage" @pagination="handlePagination" @search="handleSearch" @sort="handleSort" @aksi="handleAksi" />
      </div>
    </b-card-body>
...
import AddModal from './../../components/modal/referensi/guru/AddModal.vue'
import EditModal from './../../components/modal/referensi/guru/EditModal.vue'
import DetilModal from './../../components/modal/referensi/guru/DetilModal.vue'
  ...
  methods: {
    ...
    handleAksi(val){
      if(val.aksi === 'hapus'){
        ...
        eventBus.$emit(`open-modal-${val.aksi}-guru`, val.item);
      }
      console.log(val);
      //console.log(val);
