<template>
  <b-card>
    ...
    <b-modal ref="add-modal" size="xl" title="Tambah Data Instruktur" @show="resetModal" @hidden="resetModal" @ok="handleOk" ok-title="Simpan" cancel-title="Batal">
...
export default {
  ...
  data() {
    return {
      ...
      link_excel: '/excel/format_excel_instruktur.xlsx',
      form: {
        sekolah_id: '',
