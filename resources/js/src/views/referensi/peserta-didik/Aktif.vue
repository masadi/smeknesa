...
import AddModal from './../../components/modal/referensi/peserta-didik/AddModal.vue'
import EditModal from './../../components/modal/referensi/peserta-didik/EditModal.vue'
import DetilModal from './../../components/modal/referensi/peserta-didik/DetilModal.vue'
...
export default {
  ...
  methods: {
    handleEvent(){
      eventBus.$emit('open-modal-add-pd');
    },
    handleReload(){
      this.loadPostsData()
    },
