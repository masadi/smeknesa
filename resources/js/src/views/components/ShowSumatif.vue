        ...
        <b-tbody>
          <template v-for="(siswa, index) in data_siswa">
            <b-tr>
              ...
              <b-td><b-form-input v-model="form.nilai_sumatif[siswa.anggota_rombel.anggota_rombel_id+'#non-tes']" /></b-td>
              <b-td><b-form-input v-model="form.nilai_sumatif[siswa.anggota_rombel.anggota_rombel_id+'#tes']" /></b-td>
              <b-td><b-form-input v-model="form.nilai_sumatif[siswa.anggota_rombel.anggota_rombel_id+'#na']" /></b-td>
            </b-tr>
          </template>
        </b-tbody>
      </b-table-simple>
