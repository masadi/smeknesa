...
<template>
  <b-carousel
    ...
    indicators
  >
    <b-carousel-slide img-src="/img/slider/01.jpg" />
    <b-carousel-slide img-src="/img/slider/02.jpg" />
    <b-carousel-slide img-src="/img/slider/03.jpg" />
  </b-carousel>
</template>
...
<template>
  <div>
    ...
    >
      ...
      <b-carousel-slide img-src="/img/slider/06.jpg" />
...
<template>
  ...
  >
    <b-carousel-slide img-src="/img/slider/01.jpg" />
    <b-carousel-slide img-src="/img/slider/02.jpg" />
    <b-carousel-slide img-src="/img/slider/04.jpg" />
  </b-carousel>
</template>
...
<template>
  ...
  >
    <b-carousel-slide img-src="/img/slider/04.jpg" />
    <b-carousel-slide img-src="/img/slider/05.jpg" />
    <b-carousel-slide img-src="/img/slider/06.jpg" />
  </b-carousel>
</template>
...
<template>
  <b-carousel
    ...
    :interval="400"
  >
    <b-carousel-slide img-src="/img/slider/07.jpg" />
    <b-carousel-slide img-src="/img/slider/08.jpg" />
    <b-carousel-slide img-src="/img/slider/09.jpg" />
  </b-carousel>
</template>
