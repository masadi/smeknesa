<template>
  <b-modal v-model="addModalShow" title="Tambah Data DUDI" size="lg" @show="resetForm" @hidden="hideModal" @ok="handleOk">
...
export default {
  ...
  created() {
    ...
    eventBus.$on('open-modal-add-dudi', this.handleEvent);
  },
  methods: {
    handleEvent(){
