<template>
  <b-modal v-model="addModalShow" title="Tambah Data Peserta Didik" @show="resetForm" @hidden="hideModal" @ok="handleOk">
    <b-overlay :show="loading_form" rounded opacity="0.6" size="lg" spinner-variant="danger">
      <b-form ref="form" @submit.stop.prevent="handleSubmit">
        <b-row>
          <b-col cols="12">
            <b-button block variant="primary" href="/downloads/template-pd.xlsx" target="_blank">Download Template Excel</b-button>
          </b-col>
