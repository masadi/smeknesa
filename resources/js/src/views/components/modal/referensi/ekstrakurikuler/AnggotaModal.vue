<template>
  <b-modal v-model="anggotaModalShow" title="Anggota Ekskul" size="xl" ok-only ok-variant="secondary" ok-title="Tutup" modal-class="modal-fullscreen" scrollable @ok="hideModal" no-close-on-backdrop>
    <b-row>
      <b-col cols="6">
        <h3>Anggota Ekskul</h3>
...
export default {
  ...
  created() {
    eventBus.$on('open-modal-anggota-ekskul', this.handleEvent);
  },
  methods: {
    handleEvent(data){
