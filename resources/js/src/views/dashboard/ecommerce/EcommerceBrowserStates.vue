...
export default {
  ...
  data() {
    return {
      ...
      browserData: [
        {
          browserImg: '/img/icons/google-chrome.png',
          name: 'Google Chrome',
          usage: '54.4%',
        },
        {
          browserImg: '/img/icons/mozila-firefox.png',
          name: 'Mozila Firefox',
          usage: '6.1%',
        },
        {
          browserImg: '/img/icons/apple-safari.png',
          name: 'Apple Safari',
          usage: '14.6%',
        },
        {
          browserImg: '/img/icons/internet-explorer.png',
          name: 'Internet Explorer',
          usage: '4.2%',
        },
        {
          browserImg: '/img/icons/opera.png',
          name: 'Opera Mini',
          usage: '8.%',
        },
      ],
