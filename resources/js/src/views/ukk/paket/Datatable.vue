      ...
      <b-table responsive bordered striped :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" show-empty :busy="isBusy">
        ...
        <template v-slot:cell(actions)="row">
          <b-dropdown id="dropdown-dropleft" dropleft text="Aksi" variant="primary" size="sm" boundary="viewport">
            ...
            <b-dropdown-item href="javascript:void(0)" @click="aksi(row.item, 'status')" v-else><check-icon /> Aktifkan</b-dropdown-item>
...
import { BRow, BCol, BFormInput, BTable, BSpinner, BPagination, BDropdown, BDropdownItem, BOverlay, BBadge } from 'bootstrap-vue'
