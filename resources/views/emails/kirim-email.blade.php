		...
		<div class="proton-wrapper">
			<table class="proton-table">
				<tbody>
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							...
							<center>
								<h1>SMEKNESA</h1>
								<img src="{{ asset('img/banner/email-absen.webp') }}" alt="Image" />
							</center>
							<h4>Assalamualaiakum Bpk/Ibu <strong>{{$mailData['nama_guru']}}</strong></h4>
							<p>
								Berikut kami laporkan absensi di kelas {{$mailData['nama_kelas']}} pada hari {{$mailData['tanggal']}}.<br>
								<hr>
							<table>
                ...
                @endforeach
								...
								<br>
								<hr>
								Untuk rekapitulasi absensi lengkap bisa di download di sini
					...
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							<center>
								<a href="https://smkn1sampang.sch.id" class="proton-button" target="_blank">DOWNLOAD REKAP ABSENSI</a>
							</center>
						</td>
					</tr>
					...
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							<p>Jika ditemukan ada ketidak sesuaian data, segera menyampaikan ke guru Piket.</p><br>
								<h4>Waalaikumsalam Warahmatullahi Wabarkatuh</h4>
						</td>
					</tr>
					...
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							...
							Sistem Akademik	: https://smkn1sampang.sch.id
							</p>
						</td>
					</tr>
					...
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							...
							<center>
								<span style="color: #706d6b"> © 2023 | SMKN 1 Sampang </span>
							</center>
