...
<table width="100%" id="alamat">
	...
	<tr>
		...
		<td style="width: 35%;padding:5px;">a. Ayah</td>
		<td style="width: 1%;">:</td>
		<td style="width: 58%">{{($get_siswa->peserta_didik->pekerjaan_ayah) ? $get_siswa->peserta_didik->pekerjaan_ayah->nama : ''}}</td>
	</tr>
	<tr>
		<td style="width: 5%;">&nbsp;</td>
		<td style="width: 35%;padding:5px;">b. Ibu</td>
		<td style="width: 1%;">:</td>
		<td style="width: 58%">{{($get_siswa->peserta_didik->pekerjaan_ibu) ? $get_siswa->peserta_didik->pekerjaan_ibu->nama : ''}}</td>
	</tr>
	<tr>
