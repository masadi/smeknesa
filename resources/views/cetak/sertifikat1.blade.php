...
<br>
<br>
<h2 style="color:#000000;">{{$paket->jurusan_sp->nama_jurusan_sp}}</h2>
<h3 style="color:#000000;">{{($paket->jurusan_sp->nama_jurusan_en) ? $paket->jurusan_sp->nama_jurusan_en : ''}}</h3>
<br>
...
<br>
<br>
		<p><b>{{($sekolah->kasek) ? $sekolah->kasek->nama : $sekolah->kepala_sekolah?->nama}}</b></p>
		<p>Kepala Sekolah</p>
...
<br>
<br>
<p><b>{{$rencana_ukk->guru_eksternal->nama}}</b></p>
