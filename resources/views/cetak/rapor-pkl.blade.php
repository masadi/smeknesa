...
<p class="text-center">
  ...
  <table>
    <tbody>
      ...
      <tr>
        <td>Tanggal PKL</td>
        <td>:	Mulai	: {{ $pd->pd_pkl->praktik_kerja_lapangan->tgl_mulai }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selesai	: {{ $pd->pd_pkl->praktik_kerja_lapangan->tgl_selesai }}</td>
      </tr>
      <tr>
  ...
  <table width="100%">
    ...
    <br>
    <br>
      <p><u>{{$pd->pd_pkl->praktik_kerja_lapangan->dudi->pimpinan}}</u></p>
    </td>
    </tr>
    </table>
@endsection
